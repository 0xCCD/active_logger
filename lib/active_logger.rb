module ActiveLogger
  ...
  module ClassMethods
    ...
    def enable_logging options={}
      ...
      cattr_accessor :fields_to_ignore
  ...
  module InstanceMethods  
    ...
    def record_changes
      ...
      if new_record?
        add_log_entry({:user_id=>::ActiveLogger::User.user_id, :logged_for=>self.class.name, :logged_for_id=>read_attribute("id"), :i18n=>true, :body=>i18n_create}, {:obj=>before.to_yaml, :obj2=>changed.to_yaml})
      else
